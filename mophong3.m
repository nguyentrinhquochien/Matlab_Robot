...
%**************************
%qu? ??o 1 
%     plot([xr1,xr2,xr3,xr4,xr5],[yr1,yr2,yr3,yr4,yr5],'r--',xr,yr,'b:','LineWidth', 3);
%     title('quy dao tham chieu va quy dao thuc');
%     xlabel('truc X (m)');ylabel('Truc Y (m)');
%     legend('thucte','tham chieu',1);
%     axis equal;
%*********************
%qu? ??o s? 8 
plot([xr1,xr2,xr3,xr4,xr5,xr6,xr7,xr8],[yr1,yr2,yr3,yr4,yr5,yr6,yr7,yr8],'r--',xr,yr,'b:','LineWidth', 3);
title('quy dao tham chieu va quy dao thuc');
xlabel('truc X (m)');ylabel('Truc Y (m)');
legend('thucte','tham chieu',1);
axis equal;
%*********************
%qu? ??o hình tròn
%     plot([xr1,xr2,xr3,xr4],[yr1,yr2,yr3,yr4],'r--',xr,yr,'b:','LineWidth', 2);
%     title('quy dao tham chieu va quy dao thuc');
%     xlabel('truc X (m)');ylabel('Truc Y (m)');
%     legend('thucte','tham chieu',1);
%     axis equal;
...
figure;	plot(xbd,ybd, 'k*',xr,yr,'k --',x,y,':','LineWidth', 1);xlabel('Truc X [m]');ylabel('Truc Y [m]');axis equal; %legend('SP','CV',3);
